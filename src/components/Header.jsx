...
const Header = () => {
  return (
    <header className="bg-[#ffcb00] flex flex-col justify-center space-y-4">
      <h1 className="font-pokeho text-xl md:text-3xl xl:text-6xl font-bold text-blue-700 flex justify-center gap-8 xl:gap-16 pt-8">
        <div>P o k é m o n</div> <div>F i g h t</div>
      </h1>
      <nav>
        <ul className="flex flex-col sm:flex-row justify-between p-2">
          <Link
            to="/"
